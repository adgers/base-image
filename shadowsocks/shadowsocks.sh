...
echo "# Intro: https://www.abcdocker.com/abcdocker/2778           #"
echo "# Author: 9cyh.net                                          #"
echo "#############################################################"
echo
...
pre_install(){
    ...
    read -p "(Default password: 9cyh.net):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="9cyh.net"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit https://www.abcdocker.com/abcdocker/2778 and contact."
        install_cleanup
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://www.abcdocker.com/abcdocker/2778"
    echo "Enjoy it!"
    echo
}
